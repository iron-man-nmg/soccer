package com.nmg.soccer.generator.engine.config;
...
public class ContextConfig {
    ...
    private String proPackage = "com.nmg.soccer.admin";
    private String coreBasePackage = "com.nmg.soccer.core";
    private String modelPackageName = "com.nmg.soccer.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.nmg.soccer.admin.common.persistence.dao";  //model的dao
