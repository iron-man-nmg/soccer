...
import static com.nmg.soccer.core.util.ToolUtil.getTempPath;
import static com.nmg.soccer.core.util.ToolUtil.isEmpty;
...
public class Properties {
    ...
    public static final String PREFIX = "soccer";
