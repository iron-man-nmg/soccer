package com.nmg.soccer.core.mutidatasource.aop;

import com.nmg.soccer.core.mutidatasource.annotion.DataSource;
import com.nmg.soccer.core.mutidatasource.config.MutiDataSourceProperties;
import com.nmg.soccer.core.mutidatasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.nmg.soccer.core.mutidatasource.annotion.DataSource)")
    private void cut() {
